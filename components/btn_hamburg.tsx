...
.hamburger--stand-r.is-active .hamburger-inner {
 transform: rotate(-90deg);
 background-color: transparent !important;
 transition: transform 0.075s 0simport { Box } from '@chakra-ui/react';
 cubic-bezier(0.215, 0.61, 0.355import { Box } from '@chakra-ui/react';
, 1), background-color 0s 0.15s linear; }
